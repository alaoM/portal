...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Pay Scheule</a>
      </li>
    </ul>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
				...
				<?php
				require("connect.php");
				$SqlTable=mysqli_query($connection, "SELECT *,bank_sort.Bank  FROM users INNER JOIN bank_sort ON users.Bank = bank_sort.Bank ") or die(mysqli_error($connection));
  ...
  <!-- /.content-wrapper -->
<?php require('footer.php'); ?>  <!-- Control Sidebar -->
